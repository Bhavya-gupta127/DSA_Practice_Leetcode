...
//     int solve(int row,vector<vector<int>>&G,set<int>&vis)
//     {
//         if(row>=G.size())
//             return 0;
//         int res=0;
...
//         {
//             if(G[row][i]==1 && vis.count(i)==0)
//             {
//                 //pick
//                 vis.insert(i);
//                 res=max(solve(row+1,G,vis)+1,res);
//                 vis.erase(i);
                
//                 //notpick
//                 res=max(solve(row+1,G,vis),res);
//             }
//         }
//         return res;
//     }
